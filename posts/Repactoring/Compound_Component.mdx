...
### 📌 예제 2: `Object.assign`을 활용한 합성 컴포넌트

`Object.assign`을 활용하면 컴포넌트를 그룹화하여 더욱 직관적인 사용이 가능합니다.
...
### 3️⃣ 메인 & 서브 컴포넌트를 묶어서 `Object.assign`으로 export
...
3. **5가지 최신 고급 리액트 패턴 - ① Compound Component, Control Props, Custom Hook**
    
    [5가지 최신 고급 리액트 패턴 - ① Compound Component, Control Props, Custom Hook](https://wishket.tistory.com/12)
    
4. **React Hooks: Compound Components**
    
    [React Hooks: Compound Components](https://kentcdodds.com/blog/compound-components-with-react-hooks)
    
5. **디자인 시스템에 Compound Component Pattern 적용해보기 & 서브 컴포넌트**
...
6. 스파게티 코드의 개선으로 참고하면 좋을 **관심사를 분리**
