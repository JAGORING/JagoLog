...
export default function PostCard(props: Post) {
  return (
    <Link href={props.url} className="block">
      <div className="relative rounded-2xl border border-white/10 bg-white/5 shadow-md transition-all duration-300 hover:border-white/50 hover:shadow-lg">
        {props.thumbnail && (
        ...
        <div className="p-3">
          ...
          <p className="text-lg font-semibold text-white mt-1">{props.title}</p>
